...
public interface VisionScriptListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VisionScriptParser#seccion}.
	 * @param ctx the parse tree
	 */
	void enterSeccion(VisionScriptParser.SeccionContext ctx);
	/**
	 * Exit a parse tree produced by {@link VisionScriptParser#seccion}.
	 * @param ctx the parse tree
	 */
	void exitSeccion(VisionScriptParser.SeccionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link VisionScriptParser#operacion}.
	 * @param ctx the parse tree
	 */
	void enterOperacion(VisionScriptParser.OperacionContext ctx);
	/**
	 * Exit a parse tree produced by {@link VisionScriptParser#operacion}.
	 * @param ctx the parse tree
	 */
	void exitOperacion(VisionScriptParser.OperacionContext ctx);
	/**
	 * Enter a parse tree produced by {@link VisionScriptParser#op_termino}.
	 * @param ctx the parse tree
	 */
	void enterOp_termino(VisionScriptParser.Op_terminoContext ctx);
	/**
	 * Exit a parse tree produced by {@link VisionScriptParser#op_termino}.
	 * @param ctx the parse tree
	 */
	void exitOp_termino(VisionScriptParser.Op_terminoContext ctx);
	/**
	 * Enter a parse tree produced by {@link VisionScriptParser#op_factor}.
	 * @param ctx the parse tree
	 */
	void enterOp_factor(VisionScriptParser.Op_factorContext ctx);
	/**
	 * Exit a parse tree produced by {@link VisionScriptParser#op_factor}.
	 * @param ctx the parse tree
	 */
	void exitOp_factor(VisionScriptParser.Op_factorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link VisionScriptParser#concat_text}.
	 * @param ctx the parse tree
	 */
	void enterConcat_text(VisionScriptParser.Concat_textContext ctx);
	/**
	 * Exit a parse tree produced by {@link VisionScriptParser#concat_text}.
	 * @param ctx the parse tree
	 */
	void exitConcat_text(VisionScriptParser.Concat_textContext ctx);
}